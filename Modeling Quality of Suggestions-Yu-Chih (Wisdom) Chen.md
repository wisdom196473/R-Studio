...
![](README_figs/README-pairs plot-1.png)<!-- -->
<br/>
...
![](README_figs/README-Corrleation Reponse vs. Views-1.png)<!-- -->
<br/>
...
![](README_figs/README-Corrleation Reponse vs. Votes Up-1.png)<!-- -->
<br/>
...
![](README_figs/README-Responses vs. Votes Down-1.png)<!-- -->
<br/>
...
![](README_figs/README-Veiws vs. Votes Up-1.png)<!-- -->
<br/>
...
![](README_figs/README-Avg Tenure of with and without Recommended Suggestions-1.png)<!-- -->
...
![](README_figs/README-Density Plot-1.png)<!-- -->
<br/>
...
![](README_figs/README-All Variables Correlation-1.png)<!-- -->
<br/>
...
![](README_figs/README-Pie Chart Recommended-1.png)<!-- -->
<br/>
...
![](README_figs/README-Basr Chart Recommended-1.png)<!-- -->
<br/>
...
![](README_figs/README-Check the Orginial Data Set Balance plots-1.png)<!-- -->
<br/>
...
![](README_figs/README-Oversampling method plots-1.png)<!-- -->
<br/>
...
![](README_figs/README-Logistic Regression Residual Assessment-1.png)<!-- -->
<br/>
...
![](README_figs/README-Cooks Distance values-1.png)<!-- -->
<br/>
...
![](README_figs/README-logistic regression of training data set confusion matrix-1.png)<!-- -->
<br/>
...
![](README_figs/README-logistic regression ROC AUC Training Data Set-1.png)<!-- -->
...
![](README_figs/README-logistic regression Lift Curve Training Data Set-1.png)<!-- -->
<br/>
...
![](README_figs/README-simple logistic regression-1.png)<!-- -->
<br/> 
...
![](README_figs/README-party tree-1.png)<!-- -->
<br/>
...
![](README_figs/README-party tree plots-1.png)<!-- -->
<br/>
...
```
<br/>
-***The mis-classification rate is for the decision tree is 4.26811937470393%. ***
...
![](README_figs/README-Decision Tree Sensitivity Vs. Specificity Curve training data set-1.png)<!-- -->
...
![](README_figs/README-DecisionTree ROC training data-1.png)<!-- -->
...
![](README_figs/README-Decision Tree Lift Curve training data-1.png)<!-- -->
<br/>
...
```
<br/>
-***The mis-classification rate is for the decision tree (Testing Data Set) is 3.94088669950739%. ***
...
![](README_figs/README-Decision Tree Sensitivity Vs. Specificity Curve testing data set-1.png)<!-- -->
...
![](README_figs/README-DecisionTree ROC testing data-1.png)<!-- -->
...
![](README_figs/README-Decision Tree Lift Curve testomg data-1.png)<!-- -->
<br/>
...
![](README_figs/README-Navie Bayes Probability for Recommended training data set-1.png)<!-- -->
...
![](README_figs/README-Navie Bayes ROC and AUC training data set-1.png)<!-- -->
...
![](README_figs/README-Navie Bayes Lift Curve training data set-1.png)<!-- -->
...
![](README_figs/README-Navie Bayes Probability for Recommended testing data set-1.png)<!-- -->
...
![](README_figs/README-Navie Bayes ROC and AUC testing data set-1.png)<!-- -->
...
![](README_figs/README-Navie Bayes Lift Curve testing data set-1.png)<!-- -->
...
![](README_figs/README-Combine ROC Curve-1.png)<!-- -->
